...
export const dict = {
  ...
  'gitView.header.upstreamFetchAria': 'Fetch {target}',
  'gitView.header.upstreamFetchTooltip': 'Fetch {target}',
  'gitView.header.upstreamSyncAria': 'Sync from {target}',
  'gitView.header.upstreamSyncTooltip': 'Fetch, then pull from {target}',
  ...
  'gitView.sync.fetchTrackingTooltip': 'Fetch tracked branch {tracking}',
  'gitView.sync.pull': 'Pull',
  'gitView.sync.pullTooltip': 'Pull changes',
  'gitView.sync.pullTooltipBehind': 'Pull changes ({count} behind)',
  'gitView.sync.pullTrackingTooltip': 'Pull from tracked branch {tracking}',
  'gitView.sync.pullTrackingTooltipBehind': 'Pull from tracked branch {tracking} ({count} behind)',
  'gitView.sync.push': 'Push',
  'gitView.sync.pushTooltip': 'Push changes',
  'gitView.sync.pushTooltipAhead': 'Push changes ({count} ahead)',
  'gitView.sync.pushTrackingTooltip': 'Push to tracked branch {tracking}',
  'gitView.sync.pushTrackingTooltipAhead': 'Push to tracked branch {tracking} ({count} ahead)',
  'gitView.sync.upstreamFetch': 'Fetch upstream',
  'gitView.sync.upstreamSync': 'Sync upstream',
