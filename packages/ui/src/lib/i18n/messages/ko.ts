...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.sync.fetchTrackingTooltip': '추적 브랜치 {tracking} fetch',
  'gitView.sync.pull': 'pull',
  'gitView.sync.pullTooltip': '변경 사항 pull',
  'gitView.sync.pullTooltipBehind': 'pull changes ({count} behind)',
  'gitView.sync.pullTrackingTooltip': '추적 브랜치 {tracking}에서 pull',
  'gitView.sync.pullTrackingTooltipBehind': '추적 브랜치 {tracking}에서 pull ({count} behind)',
  'gitView.sync.push': 'push',
  'gitView.sync.pushTooltip': '변경 사항 push',
  'gitView.sync.pushTooltipAhead': 'push changes ({count} ahead)',
  'gitView.sync.pushTrackingTooltip': '추적 브랜치 {tracking}에 push',
  'gitView.sync.pushTrackingTooltipAhead': '추적 브랜치 {tracking}에 push ({count} ahead)',
  'gitView.sync.upstreamFetch': 'upstream fetch',
  'gitView.sync.upstreamSync': 'upstream 동기화',
