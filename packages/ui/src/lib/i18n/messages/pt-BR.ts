...
export const dict: Record<I18nKey, string> = {
 ...settingsDict,
  ...
  "gitView.header.upstreamSyncAria": "Sincronizar de {target}",
  "gitView.header.upstreamSyncTooltip": "Fetch e depois pull de {target}",
  ...
  "gitView.sync.fetchTrackingTooltip": "Fetch da branch rastreada {tracking}",
  "gitView.sync.pull": "Pull",
  "gitView.sync.pullTooltip": "Fazer pull",
  "gitView.sync.pullTooltipBehind": "Fazer pull ({count} detrás)",
  "gitView.sync.pullTrackingTooltip": "Pull da branch rastreada {tracking}",
  "gitView.sync.pullTrackingTooltipBehind": "Pull da branch rastreada {tracking} ({count} atrás)",
  "gitView.sync.push": "Push",
  "gitView.sync.pushTooltip": "Fazer push",
  "gitView.sync.pushTooltipAhead": "Fazer push ({count} por delante)",
  "gitView.sync.pushTrackingTooltip": "Push para a branch rastreada {tracking}",
  "gitView.sync.pushTrackingTooltipAhead": "Push para a branch rastreada {tracking} ({count} à frente)",
  "gitView.sync.upstreamFetch": "Fetch do upstream",
